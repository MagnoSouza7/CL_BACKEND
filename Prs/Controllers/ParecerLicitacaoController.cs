...
namespace Prs.Controllers
{
    ...
    public class ParecerLicitacaoController : ControllerBase
    {
        ...
        public async Task<IActionResult> Finalize(ParecerLicitacaoRequestCreate parecerLicitacao)
        {
            ...
            if (parecerLicitacaoNew.Resultado == "perdeu")
            {
                EmailService.EnviarEmailResuldoParecerLicitacaoPerdeu(
                    "Equipe Central de Licitação",
                    "carlos.silva4@globalweb.com.br",
                    //"licita@globalweb.com.br",
                    parecerLicitacaoNew.Resultado,
                    parecerLicitacaoNew.Edital.Id,
                    parecerLicitacaoNew.NossoValor,
                    parecerLicitacaoNew.Vencedor.Nome,
                    parecerLicitacaoNew.ValorVencedor,
                    parecerLicitacaoNew.NossaClassificacao);

            }
            else if(parecerLicitacaoNew.Resultado == "ganhou")
            {
                EmailService.EnviarEmailResuldoParecerLicitacaoGanhou(
                    "Equipe Central de Licitação",
                    "carlos.silva4@globalweb.com.br",
                    //"licita@globalweb.com.br",
                     parecerLicitacaoNew.Resultado,
            ...
            {
                EmailService.EnviarEmailResuldoParecerLicitacao(
                    "Equipe Central de Licitação",
                    "carlos.silva4@globalweb.com.br",
                    //"licita@globalweb.com.br",
                    parecerLicitacaoNew.Resultado,
