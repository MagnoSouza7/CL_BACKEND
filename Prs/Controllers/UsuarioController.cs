...
namespace Prs.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public async Task<IActionResult> Autenticar(string login, string senha)
        {
            try
            {
                var existe = await usuarioRepository.AuthenticateUser(login, senha);
        ...
        {
            var usuario = await usuarioRepository.GetAllUsuario();
        ...
        public async Task<IActionResult> Update(UsuarioRequestUpdate usuario)
        {
            await usuarioRepository.UpdateUser(usuario.Id, usuario.RoleId, usuario.Ativo);
