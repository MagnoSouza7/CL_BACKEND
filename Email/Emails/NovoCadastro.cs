...
namespace Email.Emails
{
    public static class NovoCadastro
    {
        public static void Send(string nome, string email)
        {
            ...
            message.Subject = "Cadastro - Central de Licitação";
            message.Body = new TextPart(TextFormat.Html)
            {
                Text = @$"
                            ...
                            <article style = 'padding: 20px' >
                                ...
                                <h3 style = 'font-size: 1.2em;font-weight: 600;letter-spacing: 0.1em;margin: 0 0 1em 0' >Realizado cadastro na Central de Licitações</h3>
                                <p style = 'font-family: &quot;Times New Roman&quot;, serif;line-height: 1.3em;margin: 0 0 1em 0;margin-bottom: 25px' >

                                Sr(a). {nome} <br/>
                                Foi realizado com sucesso o cadastro do seu usuario corporativo dentro da Central de Licitações.<br/>
        
                                O mesmo já está disponível para você acessar neste link: <a href='https://cl.globalweb.com.br/'>https://cl.globalweb.com.br/<a>
