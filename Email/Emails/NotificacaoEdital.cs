...
{
    public static class NotificacaoEdital
    {
        public static void Send(string nome, string email, Edital edital, string assunto, string titulo)
        {
            ...
            var mensagem = @$"
                            ...
                            <article style='padding: 20px'>
                                ...
                                <h3 style='font-size: 1.2em;font-weight: 600;letter-spacing: 0.1em; margin: 0 0 1em 0'>{titulo}</h3>
                                <p style='font-family: &quot;Times New Roman&quot;, serif;line-height: 1.3em;margin: 0 0 1em 0;margin-bottom: 25px'>
                            
                                Sr (a). {nome} <br/><br/>

                                Edital ID {edital.Id} <br/>
