...
{
    public static class NotificacaoCadastroLicitacao
    {
        public static void Send(string nome, string email, string titulo, Edital edital)
        {
            var message = new MimeMessage();
            message.To.Add(new MailboxAddress(nome, email));
            message.From.Add(new MailboxAddress("Central de Licitações", Config.From));

            message.Subject = "Notificação -  Central de Licitação";
            ...
            var mensagem = @$"
                            ...
                            <article style='padding: 20px'>
                                ...
                                <h3 style='font-size: 1.2em;font-weight: 600;letter-spacing: 0.1em; margin: 0 0 1em 0'>Licitação Cadastro de Eventos!</h3>
                                <p style='font-family: &quot;Times New Roman&quot;, serif;line-height: 1.3em;margin: 0 0 1em 0;margin-bottom: 25px'>

                                Você está cadastrado no Evento Abaixo <br/><br/>
                            
                                Assunto: <strong>{titulo}</strong><br/><br/>

                                Data e Hora do início do Evento: <strong>{edital.DataHoraDeAbertura.ToString("dd/MM/yyyy", CultureInfo.CurrentCulture)}</strong><br/>
                                <!--Data fim do Evento: <strong></strong><br/>
                                Hora fim do evento: <strong></strong><br/>-->
                                ID Edital Associado: <strong>{edital.Id}</strong><br/>";
