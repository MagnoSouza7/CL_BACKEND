...
namespace Infrastructure.Repository.ParecerGerente.GetWaitingGerente
{
    public class GetWaitingGerente : IGetWaitingGerente
    {
        ...
        )
        {
            ...
            var editais = await context.Editais
                    ...
                    .Where(x => x.Ativo && x.Etapa.Id == 1 && (role == "gerente" ? x.Gerente.Email == email : true)
