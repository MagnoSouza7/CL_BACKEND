...
namespace Infrastructure.Repository.ParecerDiretor.Update
{
    public class UpdateParecerDiretor : IUpdateParecerDiretor
    {
            ...
            byte[] base64Anexo2)
        {
            ...
            var anexo1New = nomeAnexo1 != null && tipoAnexo1 != null && base64Anexo1 != null ? new Domain.Entities.Anexo
            {
                Nome = nomeAnexo1,
                Tipo = tipoAnexo1,
                Base64 = base64Anexo1,
            ...
            var anexo2New = nomeAnexo2 != null && tipoAnexo2 != null && base64Anexo2 != null ? new Domain.Entities.Anexo
            {
                Nome = nomeAnexo2,
                Tipo = tipoAnexo2,
                Base64 = base64Anexo2,
