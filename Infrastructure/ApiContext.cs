...
namespace Infrastructure
{
    public class ApiContext : DbContext
    {
        ...
        public DbSet<ConsultaPublica> ConsultaPublicas { get; set; }
        public DbSet<DocumentoCL> DocumentosCLs { get; set; }

        private readonly string ConectionString = "Server=si-sqlha; Port=3307;Database=cl_database;User=cl-user-app;Password=iPZyKDEIONWr3rVq;Connect Timeout=3000;";
        //private readonly string ConectionString = "Server=si-sqlha; Port=3307;Database=cl_database_dev;User=cl-user-app;Password=iPZyKDEIONWr3rVq;Connect Timeout=3000;";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new ConsultaPublicaConfiguration());
